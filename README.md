...
*  Ensure you have the required Python libraries installed (openai, keyboard, pyautogui, pyperclip, win32gui, win32console, azure-cognitiveservices-speech, json, os, time).
